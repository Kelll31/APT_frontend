  ...
  return (
    <div className="flex flex-wrap items-center gap-3">
      <Avatar rounded="sm"  color="primary">
        <AvatarImage src="/images/avatar/av-1.jpg" alt="APT" />
        <AvatarFallback> LI </AvatarFallback>
      </Avatar>
      <Avatar rounded="md"  >
        <AvatarImage src="/images/avatar/av-2.jpg" alt="APT" />
        <AvatarFallback> PR </AvatarFallback>
      </Avatar>
      <Avatar rounded="lg"  color="secondary">
        <AvatarImage src="/images/avatar/av-3.jpg" alt="APT" />
        <AvatarFallback> SH </AvatarFallback>
      </Avatar>
  ...
  return (
    <div className="flex flex-wrap items-center gap-3">
      <Avatar shape="circle"  color="primary">
        <AvatarImage src="/images/avatar/av-4.jpg" alt="APT" />
        <AvatarFallback> LI </AvatarFallback>
      </Avatar>
      <Avatar shape="square" >
        <AvatarImage src="/images/avatar/av-1.jpg" alt="APT" />
      ...
      <TooltipProvider>
        <Tooltip>
          <TooltipTrigger>
            <Avatar>
              <AvatarImage
                src="/images/avatar/avatar-1.png" alt="APT"
              />
              <AvatarFallback> PR </AvatarFallback>
            </Avatar>
          </TooltipTrigger>
      ...
      <TooltipProvider>
        <Tooltip>
          <TooltipTrigger>
            <Avatar color="primary">
              <AvatarImage
                src="/images/avatar/avatar-2.png" alt="APT"
              />
              <AvatarFallback> LI </AvatarFallback>
            </Avatar>
          </TooltipTrigger>
      ...
      <TooltipProvider>
        <Tooltip>
          <TooltipTrigger>
            <Avatar color="secondary">
              <AvatarImage
                src="/images/avatar/avatar-3.png" alt="APT"
              />
              <AvatarFallback> SH </AvatarFallback>
            </Avatar>
          </TooltipTrigger>
      ...
      <TooltipProvider>
        <Tooltip>
          <TooltipTrigger>
            <Avatar color="success">
              <AvatarImage
                src="/images/avatar/avatar-4.png" alt="APT"
              />
              <AvatarFallback> SU </AvatarFallback>
            </Avatar>
          </TooltipTrigger>
      ...
      <TooltipProvider>
        <Tooltip>
          <TooltipTrigger>
            <Avatar color="info">
              <AvatarImage
                src="/images/avatar/avatar-5.png" alt="APT"
              />
              <AvatarFallback> PR </AvatarFallback>
            </Avatar>
          </TooltipTrigger>
      ...
      <TooltipProvider>
        <Tooltip>
          <TooltipTrigger>
            <Avatar color="warning">
              <AvatarImage
                src="/images/avatar/avatar-6.png" alt="APT"
              />
              <AvatarFallback> SR </AvatarFallback>
            </Avatar>
          </TooltipTrigger>
      ...
      <TooltipProvider>
        <Tooltip>
          <TooltipTrigger>
            <Avatar color="destructive">
              <AvatarImage
                src="/images/avatar/avatar-7.png" alt="APT"
              />
              <AvatarFallback> AR </AvatarFallback>
            </Avatar>
          </TooltipTrigger>
