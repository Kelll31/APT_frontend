...
const Register = () => {
          ...
          <div className="flex-1 relative">
            <div className=" h-full flex flex-col bg-default-50">
              <div className="max-w-[524px] md:px-[42px] md:py-[44px] p-7  mx-auto w-full text-2xl text-default-900  mb-3 h-full flex flex-col justify-center">
                ...
                <div className="text-center 2xl:mb-10 mb-5">
                  ...
                  <div className="text-default-500  text-base">
                    Создать аккаунт что бы начать пользоваться APT
                  </div>
                </div>
                <RegForm />
              ...
              <div className="text-xs font-normal text-default-500 z-[999] pb-10 text-center">
                Copyright 2025, APT All Rights Reserved.
              </div>
            </div>
          </div>
          <div
 ...
 max-w-[525px] mx-auto pb-20 text-center"
                >
                  Автоматизируй безопасность,{" "}
                  <span className="text-white font-bold ms-1">опережай угрозы</span>
                </div>
              </div>
            </div>
          </div>
