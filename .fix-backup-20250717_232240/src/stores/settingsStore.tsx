        ...
        subscribeWithSelector((set, get) => ({
            ...
            switchCategory: (category: SettingsCategory) => {
                ...
                if (!get().hasChangesInCategory(category)) {
                    get().loadCategorySettings(category).catch(error => {
            ...
            validateCategoryData: (category: SettingsCategory, data: any) => {
                ...
                switch (category) {
                    case 'profile':
                        ...
                        if (data.email && !get().isValidEmail(data.email)) errors.push('Invalid email format');
                        break;
            ...
            getDataVersion: (category: SettingsCategory) => {
                const state = get();
                return (state as any).dataVersions?.[category] || 1;
            },
