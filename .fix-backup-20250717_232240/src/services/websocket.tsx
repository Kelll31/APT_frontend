...
export class WebSocketService {
    ...
    private authData?: WebSocketAuth;
    ...
    constructor(config: WebSocketConfig = {}) {
        ...
        this.log('WebSocketService инициализирован', this.config);
    }
    ...
    private async _performConnection(): Promise<boolean> {
        return new Promise((resolve, reject) => {
            try {
                ...
                this.log('Подключение к WebSocket...', this.connectionInfo.url);
                ...
                const socketOptions = {
                    ...
                    query: {
                        ...
                        ...(this.authData ? { auth_token: this.authData.token } : {})
                    },
                    auth: {
                        ...this.config.auth,
                        ...(this.authData || {})
    ...
    private setupEventHandlers(resolve: Function, reject: Function): void {
        ...
        this.socket.on('connected', (data: any) => {
            this.log('Получено подтверждение от сервера', data);
    ...
    send(event: string, data: any = {}, callback?: Function): boolean {
        ...
        try {
            this.log(`Отправка события: ${event}`, data);
    ...
    private emit<T = any>(eventType: WebSocketEventType, data: T): void {
        ...
        this.log(`Событие: ${eventType}`, data);
