...
Configuring themes in APT is incredibly simple. The primary configuration file is type.ts. Inside the type.ts file, you can set up your theme, layout, sidebar type, sidebar color, and more. Refer to the code snippet below for all available options.
